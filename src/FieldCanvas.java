...
public class FieldCanvas extends JPanel {
	...
	public FieldCanvas(Field field2, int scale){
		this.field = field2;
		this.scale = scale;
		
		this.setPreferredSize(new Dimension((field2.getWidth()*scale)+(2*MARGINLEFT),(field2.getHeight()*scale)+(2*MARGINTOP)));
	}
	...
	public void paint(Graphics g){
	    ...
	    g2.drawRect(FieldCanvas.MARGINLEFT-1, FieldCanvas.MARGINTOP-1, (field.getWidth()*scale)+2, (scale*field.getHeight())+2);
	    g2.drawRect(FieldCanvas.MARGINLEFT-2, FieldCanvas.MARGINTOP-2, (field.getWidth()*scale)+4, (scale*field.getHeight())+4);
